...
export const ssrDrawNikkes = drawingLightWeightArray.filter(nikke => nikke.grade === "SSR" && nikke.company !== "pilgrim" && nikke.isDraw);
export const srDrawNikkes = drawingLightWeightArray.filter(nikke => nikke.grade === "SR" && nikke.isDraw);
export const rDrawNikkes = drawingLightWeightArray.filter(nikke => nikke.grade === "R" && nikke.isDraw);